      ...
      <div className="login-container">
        <div className="login-card">
          <div className="text-center mb-4">
            ...
            <p className="text-muted">Ingresá el nombre de usuario</p>
          </div>
          ...
          {result ? (
            <div>
              ...
              {result.resetUrl && (
                <div className="mb-3">
                  <label className="form-label small text-muted">Enlace de recuperación (compartilo con el usuario):</label>
                  <div className="input-group">
                    <input type="text" className="form-control form-control-sm" value={result.resetUrl} readOnly onClick={e => e.target.select()} />
                  </div>
                </div>
              )}
