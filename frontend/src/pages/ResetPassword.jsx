    ...
    <>
      ...
      <div className="login-container">
        <div className="login-card">
          ...
          {success ? (
            <div>
              <div className="alert alert-success py-2 small">Contraseña actualizada correctamente. Redirigiendo al inicio de sesión...</div>
            </div>
          ) : (
            <form onSubmit={handleSubmit}>
              <div className="mb-3">
                <label htmlFor="token" className="form-label">Token de recuperación</label>
                <input type="text" id="token" className="form-control" value={token} onChange={e => setToken(e.target.value)} required />
              </div>
              <div className="mb-3">
